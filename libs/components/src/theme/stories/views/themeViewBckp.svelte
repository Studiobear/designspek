...
<Box {...$$props} {style} theme={$theme}>
  ...
  <Box id="top" role="document" theme={$theme}>
    <header role="banner">
    ...
    <Section as="main">
      ...
      <article id="text__comments">
        <header>
          <Heading as="h3" color="color.primary">HTML Comments</Heading>
        </header>
        <div>
          <p>
      ...
      <header>
        <Heading as="h2" color="color.primary">Embedded content</Heading>
      </header>
    ...
    <Section as="section" ariaLabel="forms">
      <header>
        <Heading as="h2" color="color.primary">Form elements</Heading>
      </header>
      <form>
