...
export const withGridTemplateAreas = () => ({
  ...
  props: {
    ...
    style2: { area: 'sidebar', p: '2rem', bg: 'secondary', color: 'background' },
...
export const withGridAlignItems = () => ({
  ...
  props: {
    ...
    style1: { p: '2rem', bg: 'secondary', color: 'background', txtalign: 'right' },
    style2: { p: '2rem', bg: 'secondary', color: 'background' },
    style3: { p: '2rem', bg: 'secondary', color: 'background', txtalign: 'right' },
    style4: { p: '2rem', bg: 'secondary', color: 'background' },
    gridText1: 'This',
    gridText2: 'uses',
